// Function to determine marker size based on market
function markerSize(market) {
    return market;
  }
  ...
  for (var i = 0; i < locations.length; i++) {
    ...
    countryMarkers.push(
      L.circle(locations[i].coordinates, {
        ...
        color: "white",
        fillColor: "white",
        radius: markerSize(locations[i].country.market)
      })
    );
  ...
  var country = L.layerGroup(countryMarkers);
